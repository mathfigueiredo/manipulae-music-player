...
class Icon extends React.Component {
  renderIcon = () => {
    switch (this.props.icon) {
      case 'backward':
        return (
          <StyledWrapper clipPath={this.props.clipPath}>
            <StyledSvg
...
const StyledWrapper = styled.div`
  ...
  clip-path: ${(props) => (props.clipPath ? `url(#${props.clipPath})` : 'none')};
`;
